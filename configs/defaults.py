...
_C.AUGMENTATION.RESIZE.SIZE = (112, 112)
...
# Data loader
_C.DATA_LOADER = CN()
_C.DATA_LOADER.TRAIN_BATCH_SIZE = 8
_C.DATA_LOADER.TEST_BATCH_SIZE = 8
...
_C.MODEL.HEAD = CN()
_C.MODEL.HEAD.DIMS = [1280, 512, 9]
_C.MODEL.HEAD.DROPOUT_PROB = 0.5

_C.MODEL.EXTRACTOR = CN()
_C.MODEL.EXTRACTOR.NAME = 'efficientnet-b0'
