...
from .helpers import _make_divisible
...
class SELayer(nn.Module):
    def __init__(self, in_channels, out_channels, reduction=4):
        ...
        self.fc = nn.Sequential(
            nn.Linear(out_channels, in_channels // reduction),
...
class GhostBottleneck(nn.Module):
    def __init__(self, in_channels, hidden_dim, out_channels, kernel_size, stride, use_se):
        ...
        self.conv = nn.Sequential(
            ...
            SELayer(hidden_dim, hidden_dim) if use_se else nn.Sequential(),
        ...
        if stride == 1 and in_channels == out_channels:
            ...
            self.shortcut = nn.Sequential(
                depthwise_conv(in_channels, in_channels, kernel_size, stride, relu=False),
...
class GhostNet(nn.Module):
    def __init__(self, cfgs, num_classes=1000, width_mult=1., pretrained=None):
